...
class Athlete(MidUser):
    classes=models.ManyToManyField('training.Class',blank=True,related_name='athletes')
    coachs=models.ManyToManyField(Coach,through='SportHistory',related_name='athletes',blank=True)
    wieght=models.PositiveSmallIntegerField(default=0)
...
class Manager(BaseUser):
    reports=models.ManyToManyField('reports.Report',blank=True,related_name='managers')
    def save(self, *args, **kwargs):
        self.role = 'manager'
        super().save(*args, **kwargs)
