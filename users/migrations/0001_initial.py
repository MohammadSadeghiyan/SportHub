    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('receptionist', 'Receptionist'), ('coach', 'Coach'), ('manager', 'Manager'), ('athlete', 'Athelete')], default='athlete', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('home_number', phonenumber_field.modelfields.PhoneNumberField(max_length=128, region='IR', validators=[users.helpers.validate_iran_home_phone])),
                ('father_name', models.CharField(max_length=100, verbose_name='father name')),
                ('age', models.SmallIntegerField()),
                ('image', models.ImageField(blank=True, null=True, upload_to=users.helpers.upload_to_role_based_path)),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
